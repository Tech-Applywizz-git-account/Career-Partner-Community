      ...
      <div className="animate-in fade-in slide-in-from-left-4 duration-500">
        ...
        <div className="bg-white rounded-2xl p-2 border border-gray-100 shadow-sm mb-8">
          <div className="flex items-center gap-4 p-4">
            ...
            <div>
              <h2 className="text-2xl font-[900] text-[#24385E]">{normalizeDisplayName(selectedCompany)}</h2>
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
        <div>
          <h2 className="text-3xl font-[900] text-[#24385E] mb-1">Companies that Sponsor</h2>
