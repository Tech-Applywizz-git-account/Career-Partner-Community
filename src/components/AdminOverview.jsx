        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-50 flex items-center justify-between hover:shadow-md transition-all duration-300">
                    <div>
                        ...
                        <h3 className="text-3xl font-black text-[#29FE29] tracking-tight">{formatCurrency(stats.totalRevenue)}</h3>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-50 flex items-center justify-between hover:shadow-md transition-all duration-300">
                    <div>
                        ...
                        <h3 className="text-3xl font-black text-[#29FE29] tracking-tight">{stats.totalUsers}</h3>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-50 flex items-center justify-between hover:shadow-md transition-all duration-300">
                    <div>
                        ...
                        <h3 className="text-3xl font-black text-[#29FE29] tracking-tight">{stats.activeJobs}</h3>
                        <p className="text-[11px] text-[#29FE29] font-bold flex items-center mt-2 bg-[#29FE29]/10 w-fit px-2 py-0.5 rounded">
                            <Briefcase className="w-3 h-3 mr-1" /> Listed
                        </p>
                    </div>
                    <div className="p-4 bg-[#29FE29]/10 rounded-2xl">
                        <Briefcase className="w-8 h-8 text-[#29FE29]" />
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-50 flex items-center justify-between hover:shadow-md transition-all duration-300">
                    <div>
                        ...
                        <h3 className="text-3xl font-black text-[#29FE29] tracking-tight">
                            {stats.totalUsers > 0
                    ...
                    <div className="p-4 bg-[#29FE29]/10 rounded-2xl">
                        <TrendingUp className="w-8 h-8 text-[#29FE29]" />
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    <h3 className="text-xl font-black text-[#29FE29] mb-8 flex items-center gap-2">
                                            ...
                                            <div className="min-w-0 flex-1 pt-1 flex justify-between space-x-4">
                                                <div>
                                                    <p className="text-sm text-gray-500 font-medium">
                                                        <span className="font-bold text-[#29FE29]">{activity.title}</span>: {activity.desc}
                                                    </p>
                ...
                {/* Quick Actions */}
                <div className="bg-[#29FE29] rounded-3xl shadow-xl p-8 text-[#1E1E1E] relative overflow-hidden group">
                    ...
                    <div className="space-y-4 relative z-10">
                        ...
                        <button className="w-full text-left px-5 py-4 rounded-2xl bg-[#29FE29] hover:bg-[#29FE29]/100 transition-all flex items-center gap-4 shadow-lg group/btn active:scale-95">
                            <div className="p-2.5 bg-black/10 rounded-xl">
                                <Briefcase className="w-5 h-5 text-[#29FE29]" />
                            </div>
                            <div>
                                <p className="font-bold text-sm tracking-tight text-[#29FE29]">Post Global Job</p>
                                <p className="text-[10px] text-[#29FE29]/60 font-bold mt-0.5">Sync to all users</p>
                            </div>
                        </button>
                    </div>
                </div>
