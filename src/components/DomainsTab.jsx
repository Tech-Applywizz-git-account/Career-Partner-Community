      ...
      <div className="animate-in fade-in slide-in-from-left-4 duration-500">
        ...
        <div className="bg-white rounded-2xl p-2 border border-gray-100 shadow-sm mb-8">
          <div className="flex items-center gap-4 p-4">
            ...
            <div>
              <h2 className="text-2xl font-[900] text-[#24385E]">{selectedDomain}</h2>
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
        <div>
          <h2 className="text-3xl font-[900] text-[#24385E] mb-1">All Domains</h2>
        ...
        <div className="flex items-center gap-4 flex-1 max-w-xl">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-white border border-gray-200 rounded-xl pl-12 pr-4 py-3 text-sm font-bold text-[#24385E] outline-none focus:ring-2 focus:ring-[#FDB913]/50 focus:border-[#FDB913] transition-all"
            />
          </div>
            ...
            {['All', 'Tech', 'Non-Tech'].map((f) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-xs font-black transition-all ${
                  filter === f ? 'bg-[#24385E] text-white shadow-sm' : 'text-gray-500 hover:text-gray-700'
                }`}
              >
                {f}
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {pagedDomains.map((domain, idx) => (
            <div
              ...
              className="group relative bg-white rounded-xl p-5 border border-gray-100 shadow-sm hover:shadow-md hover:border-[#FDB913]/30 transition-all duration-300 cursor-pointer overflow-hidden flex flex-col"
            >
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex flex-col items-end gap-1.5">
                  <span className={`text-[9px] font-black px-2 py-0.5 rounded-full ${
                    domain.type === 'TECH' ? 'bg-blue-50 text-[#2563EB]' : 'bg-gray-50 text-gray-500'
                  }`}>
                    {domain.type}
                  </span>
                  <span className="text-[9px] font-black px-2 py-0.5 bg-[#FDB913]/10 text-[#24385E] border border-[#FDB913]/30 rounded-full">
              ...
              <div className="mt-auto">
                <h3 className="text-lg font-bold text-[#24385E] mb-4 group-hover:text-[#FDB913] transition-colors leading-tight">
                  {domain.name}
                </h3>
                <div className="flex items-center gap-1.5 text-[#2563EB]/50 font-bold text-xs group-hover:text-[#2563EB] transition-colors">
